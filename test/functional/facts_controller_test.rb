...
class FactsControllerTest < ActionController::TestCase
  ...
  test "should create fact" do
    assert_difference('Fact.count') do
      post :create, fact: { display_order: @fact.display_order, table_display_name: @fact.table_display_name, table_name: @fact.table_name }
    end
  ...
  test "should update fact" do
    put :update, id: @fact, fact: { display_order: @fact.display_order, table_display_name: @fact.table_display_name, table_name: @fact.table_name }
    assert_redirected_to fact_path(assigns(:fact))
  end
