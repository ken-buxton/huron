...
class DimensionsControllerTest < ActionController::TestCase
  ...
  test "should create dimension" do
    assert_difference('Dimension.count') do
      post :create, dimension: { display_order: @dimension.display_order, table_display_name: @dimension.table_display_name, table_name: @dimension.table_name }
    end
  ...
  test "should update dimension" do
    put :update, id: @dimension, dimension: { display_order: @dimension.display_order, table_display_name: @dimension.table_display_name, table_name: @dimension.table_name }
    assert_redirected_to dimension_path(assigns(:dimension))
  end
